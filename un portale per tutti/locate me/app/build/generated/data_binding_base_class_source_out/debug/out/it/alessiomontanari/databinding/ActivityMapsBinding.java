...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btSveMrk;

  private ActivityMapsBinding(@NonNull RelativeLayout rootView, @NonNull Button btSveMrk) {
    this.rootView = rootView;
    this.btSveMrk = btSveMrk;
  }
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.bt_sve_mrk;
      Button btSveMrk = ViewBindings.findChildViewById(rootView, id);
      if (btSveMrk == null) {
        break missingId;
      }

      return new ActivityMapsBinding((RelativeLayout) rootView, btSveMrk);
    }
