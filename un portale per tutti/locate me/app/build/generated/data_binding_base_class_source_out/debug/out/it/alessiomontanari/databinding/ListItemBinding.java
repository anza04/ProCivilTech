...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull RelativeLayout rootView, @NonNull TextView tvContent,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((RelativeLayout) rootView, tvContent, tvTitle);
    }
